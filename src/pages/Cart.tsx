...
import { CartEmpty, CartItem, ClearButton } from "../components";
...
const Cart: React.FC = () => {
  ...
  const cartItems = items.map((item, index: number) => <CartItem key={index} {...item} />);
      ...
      <div className="cart">
        <div className="cart__top">
          ...
          <ClearButton
            ...
            question="Do you really want to empty your cart?"
